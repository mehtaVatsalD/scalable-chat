...
/**
 * Interactive test client for Scenario 1 (Local Delivery).
 * Run two instances of this to test cross-user messaging on the same server.
 */
public class ChatTestClient {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
                    ...
                    public void afterConnected(StompSession session, StompHeaders connectedHeaders) {
                        ...
                        session.subscribe("/user/queue/messages", new StompFrameHandler() {
                            ...
                            public void handleFrame(StompHeaders headers, Object payload) {
                                ...
                                log.info(">>> [FROM {} TO {}]: {}", msg.getSenderId(), msg.getReceiverId(),
                                        msg.getContent());
                            }
                        });
                    }
        ...
        while (true) {
            ...
            msg.setReceiverIds(Collections.singletonList(target));
            msg.setContent(text);
