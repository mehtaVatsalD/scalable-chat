...
/**
 * A STOMP client designed to FAIL heartbeats. It bypasses the TaskScheduler requirement by
 * providing a No-Op implementation.
 */
  ...
  public static void main(String[] args)
    ...
    System.out.println(
        "Connecting to "
            ...
            + " as user: "
            + userId
            + " (SILENT MODE - BYPASSING HEARTBEATS)...");
            ...
            .connectAsync(
                ...
                new StompSessionHandlerAdapter() {
                  ...
                  public void afterConnected(StompSession session, StompHeaders connectedHeaders) {
                    ...
                    System.out.println(
                        "Now staying silent. Server should kick us out in ~30-45 seconds.");
                  }
