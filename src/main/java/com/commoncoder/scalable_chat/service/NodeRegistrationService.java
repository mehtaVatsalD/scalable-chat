...
/**
 * Service responsible for registering the node with the inter-node
 * communication system on startup and cleanup on shutdown.
 */
@Service
public class NodeRegistrationService implements ApplicationRunner {
    ...
    public NodeRegistrationService(ServerMetadata serverMetadata,
