...
/**
 * Concrete implementation of RemoteMessageReceiver that bridges inter-node
 * messages to the locally connected clients.
 */
@Service
public class DefaultRemoteMessageReceiver implements RemoteMessageReceiver {
    ...
    public void onMessage(InterNodeChatMessage message) {
        log.info("Received inter-node message for user {}: {}", message.getReceiverId(), message.getContent());
