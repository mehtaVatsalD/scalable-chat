...
public class RedisRemoteSubscriptionService implements RemoteSubscriptionService {
    ...
    public RedisRemoteSubscriptionService(RedisMessageListenerContainer container, ObjectMapper objectMapper) {
        ...
        container.addMessageListener(new MessageListener() {
            ...
            public void onMessage(Message message, byte[] pattern) {
                try {
                    ...
                    InterNodeChatMessage chatMessage = objectMapper.readValue(message.getBody(),
                            InterNodeChatMessage.class);
